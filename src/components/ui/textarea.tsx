...
/**
 * Renders a styled textarea element with customizable classes and props.
 *
 * Combines default styling with any additional classes provided, and forwards all other props to the underlying `<textarea>` element.
 */
